...
const random = length => {
  ...
  const num = parseInt(Date.now() + Math.random() * 10000000);
...
export default {
  ...
  methods: {
    addRow() {
      const rowNum = this.params.data.length;
      const columnNum = this.params.data[0].length;
    ...
    toggleHeader() {
      const curr = tableHeaderTypes.indexOf(this.params.header);
    ...
    getCheckedRowDatas() {
      if (this.$refs && this.$refs.table) {
        console.log(
          "[ getCheckedRowDatas ] ",
          this.$refs.table.getCheckedRowDatas()
        );
        console.log(
          "[ getCheckedRowIndexs ] ",
          this.$refs.table.getCheckedRowIndexs()
        );
        console.log(
          "[ getCheckedRowNum ] ",
          this.$refs.table.getCheckedRowNum()
        );
  ...
  components: { NavMenu, NavBar, VueMsg, vuescroll, VueTableDynamic }
};
</script>
